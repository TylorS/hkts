...
import { createHigherKindedTypeScriptServices } from '../language/hkts-module.js';
...
export default function(): void {
    ...
    const fileExtensions = HigherKindedTypeScriptLanguageMetaData.fileExtensions.join(', ');
    program
        .command('generate')
